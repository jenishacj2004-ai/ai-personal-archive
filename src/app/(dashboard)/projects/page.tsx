    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight flex items-center gap-2.5">
            ...
            <span>Projects & Portfolio Hub</span>
          </h1>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">
            Track software architectures, GitHub repositories, live deployments, and key engineering deliverables.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 px-4 bg-slate-900/40 rounded-3xl border border-slate-800 space-y-4">
          <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 mx-auto flex items-center justify-center">
            <FolderGit2 className="w-7 h-7" />
          </div>
          <div>
            <h3 className="text-base font-bold text-white">No Projects Logged Yet</h3>
            <p className="text-xs text-slate-400 max-w-sm mx-auto mt-1">
              Document your full-stack applications, ML pipelines, and client case studies with architecture specs.
            </p>
          </div>
          <Link
            href="/archive/upload"
